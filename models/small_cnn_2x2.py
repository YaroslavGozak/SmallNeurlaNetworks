...
class Small_CNN_2x2(nn.Module):
    
    # Contructor
    def __init__(self):
        super(Small_CNN_2x2, self).__init__()
        # The reason we start with 1 channel is because we have a single black and white image
        # Channel Width after this layer is 16
        self.cnn1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=2, stride=1, padding=1)
        self.relu1 = nn.ReLU(inplace=True)
        # Channel Wifth after this layer is 9
        self.maxpool1=nn.MaxPool2d(kernel_size=2)
        
        # Channel Width after this layer is 8
        self.cnn2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=2, stride=1, padding=1)
