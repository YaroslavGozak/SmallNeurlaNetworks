...
class Small_CNN_Generic_10_layers_dp(Small_CNN_Generic_2_layers):
    ...
    def __init__(self, first_layer_kernel_size, second_layer_kernel_size, channels, image_resolution: int, dilation: int = 1, stride: int = 1, dropout_p: float = 0.25):
        super(Small_CNN_Generic_10_layers_dp, self).__init__(first_layer_kernel_size, second_layer_kernel_size, channels, image_resolution, dilation, stride)
        ...
        self.dropout9 = nn.Dropout2d(p=dropout_p)
        self.cnn10 = nn.Conv2d(in_channels=channels[4], out_channels=channels[4], kernel_size=default_kernel_size, stride=1, padding=padding)
        self.relu10 = nn.ReLU(inplace=True)
        self.dropout10 = nn.Dropout2d(p=dropout_p)
