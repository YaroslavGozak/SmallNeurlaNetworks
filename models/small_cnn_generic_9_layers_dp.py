...
class Small_CNN_Generic_9_layers_dp(Small_CNN_Generic_2_layers):
    ...
    def __init__(self, first_layer_kernel_size, second_layer_kernel_size, channels, image_resolution: int, dilation: int = 1, stride: int = 1, dropout_p: float = 0.25):
        super(Small_CNN_Generic_9_layers_dp, self).__init__(first_layer_kernel_size, second_layer_kernel_size, channels, image_resolution, dilation, stride)
