...
class Small_CNN_Generic_Cifar_32_channels(nn.Module):
    
    # Contructor
    def __init__(self, first_layer_kernel_size, second_layer_kernel_size, image_resolution: int):
        super(Small_CNN_Generic_Cifar_32_channels, self).__init__()
        ...
        self.cnn2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=second_layer_kernel_size, stride=1, padding=padding)
